...
HITDETECTIONSYSTEM_API UClass* Z_Construct_UClass_UHitZone();
...
FClassRegistrationInfo Z_Registration_Info_UClass_UHitZone;
UClass* UHitZone::GetPrivateStaticClass()
{
	using TClass = UHitZone;
	if (!Z_Registration_Info_UClass_UHitZone.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("HitZone"),
			Z_Registration_Info_UClass_UHitZone.InnerSingleton,
			StaticRegisterNativesUHitZone,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UHitZone.InnerSingleton;
}
UClass* Z_Construct_UClass_UHitZone_NoRegister()
{
	return UHitZone::GetPrivateStaticClass();
}
struct Z_Construct_UClass_UHitZone_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UHitZone_GetHitZoneHandler, "GetHitZoneHandler" }, // 3198394564
	};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_ProjectEK_Plugins_VUEDK_HitDetectionSystem_Source_HitDetectionSystem_Public_Interfaces_HitZone_h__Script_HitDetectionSystem_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UHitZone, UHitZone::StaticClass, TEXT("UHitZone"), &Z_Registration_Info_UClass_UHitZone, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHitZone), 3854545750U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ProjectEK_Plugins_VUEDK_HitDetectionSystem_Source_HitDetectionSystem_Public_Interfaces_HitZone_h__Script_HitDetectionSystem_3942332422(TEXT("/Script/HitDetectionSystem"),
	Z_CompiledInDeferFile_FID_ProjectEK_Plugins_VUEDK_HitDetectionSystem_Source_HitDetectionSystem_Public_Interfaces_HitZone_h__Script_HitDetectionSystem_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_ProjectEK_Plugins_VUEDK_HitDetectionSystem_Source_HitDetectionSystem_Public_Interfaces_HitZone_h__Script_HitDetectionSystem_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
