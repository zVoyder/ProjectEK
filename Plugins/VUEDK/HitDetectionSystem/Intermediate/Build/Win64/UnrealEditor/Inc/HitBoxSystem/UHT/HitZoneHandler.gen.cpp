...
#include "HitBoxSystem/Public/HitZones/HitZoneHandler.h"
...
HITBOXSYSTEM_API UClass* Z_Construct_UClass_UHitZoneHandler();
HITBOXSYSTEM_API UClass* Z_Construct_UClass_UHitZoneHandler_NoRegister();
HITBOXSYSTEM_API UEnum* Z_Construct_UEnum_HitBoxSystem_EHitZoneRedirectorMode();
...
struct Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitAnyDamage__DelegateSignature_Statics
{
	struct _Script_HitBoxSystem_eventOnZoneHitAnyDamage_Parms
	{
		float PureDamage;
		float TotalDamage;
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitAnyDamage__DelegateSignature_Statics::NewProp_PureDamage = { "PureDamage", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_HitBoxSystem_eventOnZoneHitAnyDamage_Parms, PureDamage), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitAnyDamage__DelegateSignature_Statics::NewProp_TotalDamage = { "TotalDamage", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_HitBoxSystem_eventOnZoneHitAnyDamage_Parms, TotalDamage), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitAnyDamage__DelegateSignature_Statics::NewProp_DamageType = { "DamageType", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_HitBoxSystem_eventOnZoneHitAnyDamage_Parms, DamageType), Z_Construct_UClass_UDamageType_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_DamageType_MetaData), NewProp_DamageType_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitAnyDamage__DelegateSignature_Statics::NewProp_InstigatedBy = { "InstigatedBy", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_HitBoxSystem_eventOnZoneHitAnyDamage_Parms, InstigatedBy), Z_Construct_UClass_AController_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitAnyDamage__DelegateSignature_Statics::NewProp_DamageCauser = { "DamageCauser", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_HitBoxSystem_eventOnZoneHitAnyDamage_Parms, DamageCauser), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitAnyDamage__DelegateSignature_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitAnyDamage__DelegateSignature_Statics::NewProp_PureDamage,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitAnyDamage__DelegateSignature_Statics::NewProp_TotalDamage,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitAnyDamage__DelegateSignature_Statics::NewProp_DamageType,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitAnyDamage__DelegateSignature_Statics::NewProp_InstigatedBy,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitAnyDamage__DelegateSignature_Statics::NewProp_DamageCauser,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitAnyDamage__DelegateSignature_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitAnyDamage__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_HitBoxSystem, nullptr, "OnZoneHitAnyDamage__DelegateSignature", nullptr, nullptr, Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitAnyDamage__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitAnyDamage__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitAnyDamage__DelegateSignature_Statics::_Script_HitBoxSystem_eventOnZoneHitAnyDamage_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitAnyDamage__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitAnyDamage__DelegateSignature_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitAnyDamage__DelegateSignature_Statics::_Script_HitBoxSystem_eventOnZoneHitAnyDamage_Parms) < MAX_uint16);
UFunction* Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitAnyDamage__DelegateSignature()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitAnyDamage__DelegateSignature_Statics::FuncParams);
	}
	return ReturnFunction;
}
void FOnZoneHitAnyDamage_DelegateWrapper(const FMulticastScriptDelegate& OnZoneHitAnyDamage, float PureDamage, float TotalDamage, const UDamageType* DamageType, AController* InstigatedBy, AActor* DamageCauser)
{
	struct _Script_HitBoxSystem_eventOnZoneHitAnyDamage_Parms
	{
		float PureDamage;
	...
	_Script_HitBoxSystem_eventOnZoneHitAnyDamage_Parms Parms;
...
struct Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitPointDamage__DelegateSignature_Statics
{
	struct _Script_HitBoxSystem_eventOnZoneHitPointDamage_Parms
	{
		float PureDamage;
		float TotalDamage;
		FVector HitLocation;
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitPointDamage__DelegateSignature_Statics::NewProp_PureDamage = { "PureDamage", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_HitBoxSystem_eventOnZoneHitPointDamage_Parms, PureDamage), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitPointDamage__DelegateSignature_Statics::NewProp_TotalDamage = { "TotalDamage", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_HitBoxSystem_eventOnZoneHitPointDamage_Parms, TotalDamage), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FStructPropertyParams Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitPointDamage__DelegateSignature_Statics::NewProp_HitLocation = { "HitLocation", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_HitBoxSystem_eventOnZoneHitPointDamage_Parms, HitLocation), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FStructPropertyParams Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitPointDamage__DelegateSignature_Statics::NewProp_HitNormal = { "HitNormal", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_HitBoxSystem_eventOnZoneHitPointDamage_Parms, HitNormal), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FNamePropertyParams Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitPointDamage__DelegateSignature_Statics::NewProp_BoneName = { "BoneName", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_HitBoxSystem_eventOnZoneHitPointDamage_Parms, BoneName), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitPointDamage__DelegateSignature_Statics::NewProp_DamageType = { "DamageType", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_HitBoxSystem_eventOnZoneHitPointDamage_Parms, DamageType), Z_Construct_UClass_UDamageType_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_DamageType_MetaData), NewProp_DamageType_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitPointDamage__DelegateSignature_Statics::NewProp_InstigatedBy = { "InstigatedBy", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_HitBoxSystem_eventOnZoneHitPointDamage_Parms, InstigatedBy), Z_Construct_UClass_AController_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitPointDamage__DelegateSignature_Statics::NewProp_DamageCauser = { "DamageCauser", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_HitBoxSystem_eventOnZoneHitPointDamage_Parms, DamageCauser), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitPointDamage__DelegateSignature_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitPointDamage__DelegateSignature_Statics::NewProp_PureDamage,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitPointDamage__DelegateSignature_Statics::NewProp_TotalDamage,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitPointDamage__DelegateSignature_Statics::NewProp_HitLocation,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitPointDamage__DelegateSignature_Statics::NewProp_HitNormal,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitPointDamage__DelegateSignature_Statics::NewProp_BoneName,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitPointDamage__DelegateSignature_Statics::NewProp_DamageType,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitPointDamage__DelegateSignature_Statics::NewProp_InstigatedBy,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitPointDamage__DelegateSignature_Statics::NewProp_DamageCauser,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitPointDamage__DelegateSignature_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitPointDamage__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_HitBoxSystem, nullptr, "OnZoneHitPointDamage__DelegateSignature", nullptr, nullptr, Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitPointDamage__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitPointDamage__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitPointDamage__DelegateSignature_Statics::_Script_HitBoxSystem_eventOnZoneHitPointDamage_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitPointDamage__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitPointDamage__DelegateSignature_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitPointDamage__DelegateSignature_Statics::_Script_HitBoxSystem_eventOnZoneHitPointDamage_Parms) < MAX_uint16);
UFunction* Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitPointDamage__DelegateSignature()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitPointDamage__DelegateSignature_Statics::FuncParams);
	}
	return ReturnFunction;
}
void FOnZoneHitPointDamage_DelegateWrapper(const FMulticastScriptDelegate& OnZoneHitPointDamage, float PureDamage, float TotalDamage, FVector HitLocation, FVector HitNormal, FName BoneName, const UDamageType* DamageType, AController* InstigatedBy, AActor* DamageCauser)
{
	struct _Script_HitBoxSystem_eventOnZoneHitPointDamage_Parms
	{
		float PureDamage;
	...
	_Script_HitBoxSystem_eventOnZoneHitPointDamage_Parms Parms;
	Parms.PureDamage=PureDamage;
	Parms.TotalDamage=TotalDamage;
...
struct Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitRadialDamage__DelegateSignature_Statics
{
	struct _Script_HitBoxSystem_eventOnZoneHitRadialDamage_Parms
	{
		float PureDamage;
		float TotalDamage;
		const UDamageType* DamageType;
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitRadialDamage__DelegateSignature_Statics::NewProp_PureDamage = { "PureDamage", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_HitBoxSystem_eventOnZoneHitRadialDamage_Parms, PureDamage), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitRadialDamage__DelegateSignature_Statics::NewProp_TotalDamage = { "TotalDamage", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_HitBoxSystem_eventOnZoneHitRadialDamage_Parms, TotalDamage), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitRadialDamage__DelegateSignature_Statics::NewProp_DamageType = { "DamageType", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_HitBoxSystem_eventOnZoneHitRadialDamage_Parms, DamageType), Z_Construct_UClass_UDamageType_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_DamageType_MetaData), NewProp_DamageType_MetaData) };
const UECodeGen_Private::FStructPropertyParams Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitRadialDamage__DelegateSignature_Statics::NewProp_Origin = { "Origin", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_HitBoxSystem_eventOnZoneHitRadialDamage_Parms, Origin), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FStructPropertyParams Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitRadialDamage__DelegateSignature_Statics::NewProp_HitInfo = { "HitInfo", nullptr, (EPropertyFlags)0x0010008008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_HitBoxSystem_eventOnZoneHitRadialDamage_Parms, HitInfo), Z_Construct_UScriptStruct_FHitResult, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_HitInfo_MetaData), NewProp_HitInfo_MetaData) }; // 4100991306
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitRadialDamage__DelegateSignature_Statics::NewProp_InstigatedBy = { "InstigatedBy", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_HitBoxSystem_eventOnZoneHitRadialDamage_Parms, InstigatedBy), Z_Construct_UClass_AController_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitRadialDamage__DelegateSignature_Statics::NewProp_DamageCauser = { "DamageCauser", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_HitBoxSystem_eventOnZoneHitRadialDamage_Parms, DamageCauser), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitRadialDamage__DelegateSignature_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitRadialDamage__DelegateSignature_Statics::NewProp_PureDamage,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitRadialDamage__DelegateSignature_Statics::NewProp_TotalDamage,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitRadialDamage__DelegateSignature_Statics::NewProp_DamageType,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitRadialDamage__DelegateSignature_Statics::NewProp_Origin,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitRadialDamage__DelegateSignature_Statics::NewProp_HitInfo,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitRadialDamage__DelegateSignature_Statics::NewProp_InstigatedBy,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitRadialDamage__DelegateSignature_Statics::NewProp_DamageCauser,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitRadialDamage__DelegateSignature_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitRadialDamage__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_HitBoxSystem, nullptr, "OnZoneHitRadialDamage__DelegateSignature", nullptr, nullptr, Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitRadialDamage__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitRadialDamage__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitRadialDamage__DelegateSignature_Statics::_Script_HitBoxSystem_eventOnZoneHitRadialDamage_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitRadialDamage__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitRadialDamage__DelegateSignature_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitRadialDamage__DelegateSignature_Statics::_Script_HitBoxSystem_eventOnZoneHitRadialDamage_Parms) < MAX_uint16);
UFunction* Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitRadialDamage__DelegateSignature()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitRadialDamage__DelegateSignature_Statics::FuncParams);
	}
	return ReturnFunction;
}
void FOnZoneHitRadialDamage_DelegateWrapper(const FMulticastScriptDelegate& OnZoneHitRadialDamage, float PureDamage, float TotalDamage, const UDamageType* DamageType, FVector Origin, FHitResult const& HitInfo, AController* InstigatedBy, AActor* DamageCauser)
{
	struct _Script_HitBoxSystem_eventOnZoneHitRadialDamage_Parms
	{
		float PureDamage;
	...
	_Script_HitBoxSystem_eventOnZoneHitRadialDamage_Parms Parms;
	Parms.PureDamage=PureDamage;
	Parms.TotalDamage=TotalDamage;
	Parms.DamageType=DamageType;
	Parms.Origin=Origin;
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UHitZoneHandler_OnTakeRadialDamage_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UHitZoneHandler, nullptr, "OnTakeRadialDamage", nullptr, nullptr, Z_Construct_UFunction_UHitZoneHandler_OnTakeRadialDamage_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UHitZoneHandler_OnTakeRadialDamage_Statics::PropPointers), sizeof(Z_Construct_UFunction_UHitZoneHandler_OnTakeRadialDamage_Statics::HitZoneHandler_eventOnTakeRadialDamage_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00C40401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UHitZoneHandler_OnTakeRadialDamage_Statics::Function_MetaDataParams), Z_Construct_UFunction_UHitZoneHandler_OnTakeRadialDamage_Statics::Function_MetaDataParams) };
...
IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UHitZoneHandler);
UClass* Z_Construct_UClass_UHitZoneHandler_NoRegister()
{
	return UHitZoneHandler::StaticClass();
}
struct Z_Construct_UClass_UHitZoneHandler_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UHitZoneHandler_OnTakePointDamage, "OnTakePointDamage" }, // 982271742
		{ &Z_Construct_UFunction_UHitZoneHandler_OnTakeRadialDamage, "OnTakeRadialDamage" }, // 3100283916
	};
...
const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UHitZoneHandler_Statics::NewProp_OnZoneHitAnyDamage = { "OnZoneHitAnyDamage", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UHitZoneHandler, OnZoneHitAnyDamage), Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitAnyDamage__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OnZoneHitAnyDamage_MetaData), NewProp_OnZoneHitAnyDamage_MetaData) }; // 189295160
const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UHitZoneHandler_Statics::NewProp_OnZoneHitPointDamage = { "OnZoneHitPointDamage", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UHitZoneHandler, OnZoneHitPointDamage), Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitPointDamage__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OnZoneHitPointDamage_MetaData), NewProp_OnZoneHitPointDamage_MetaData) }; // 1834267910
const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UHitZoneHandler_Statics::NewProp_OnZoneHitRadialDamage = { "OnZoneHitRadialDamage", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UHitZoneHandler, OnZoneHitRadialDamage), Z_Construct_UDelegateFunction_HitBoxSystem_OnZoneHitRadialDamage__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OnZoneHitRadialDamage_MetaData), NewProp_OnZoneHitRadialDamage_MetaData) }; // 3406097586
...
template<> HITBOXSYSTEM_API UClass* StaticClass<UHitZoneHandler>()
{
	return UHitZoneHandler::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_ProjectBW_Plugins_VUEDK_HitBoxSystem_Source_HitBoxSystem_Public_HitZones_HitZoneHandler_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UHitZoneHandler, UHitZoneHandler::StaticClass, TEXT("UHitZoneHandler"), &Z_Registration_Info_UClass_UHitZoneHandler, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHitZoneHandler), 1638244936U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ProjectBW_Plugins_VUEDK_HitBoxSystem_Source_HitBoxSystem_Public_HitZones_HitZoneHandler_h_3697248682(TEXT("/Script/HitBoxSystem"),
	Z_CompiledInDeferFile_FID_ProjectBW_Plugins_VUEDK_HitBoxSystem_Source_HitBoxSystem_Public_HitZones_HitZoneHandler_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_ProjectBW_Plugins_VUEDK_HitBoxSystem_Source_HitBoxSystem_Public_HitZones_HitZoneHandler_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
