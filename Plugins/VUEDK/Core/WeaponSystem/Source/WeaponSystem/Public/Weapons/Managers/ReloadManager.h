...
private:
	...
	bool TryInstantReload(const FReloadRequest& Request, int32 ReloadableBehaviourIndex);
	
	bool TryStartReloadMontage(const int32 BehaviourIndex = 0) const;
	...
	FReloadEventData CreateReloadEvent(const FReloadRequest& Request) const;
